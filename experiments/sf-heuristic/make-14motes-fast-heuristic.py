...
configurations = {
'sfl_120ms_motes_14_top_fast_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 12,
    "delta": 0.00
},
'sfl_200ms_motes_14_top_fast_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 20,
    "delta": 0.00
},
'sfl_280ms_motes_14_top_fast_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 28,
    "delta": 0.00
},
'sfl_360ms_motes_14_top_fast_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 36,
    "delta": 0.00
}
...
if __name__ == "__main__":
    ...
    for c_name, c in configurations.items():
        ...
        config["sf-heuristic"]["heuristic"] = 'fast'
