...
configurations = {
'sfl_120ms_motes_14_top_reliable_slots_df_': {
    "slotDuration": 0.01,
    "slotframeLength": 12
},
'sfl_200ms_motes_14_top_reliable_slots_df_': {
    "slotDuration": 0.01,
    "slotframeLength": 20
},
'sfl_280ms_motes_14_top_reliable_slots_df_': {
    "slotDuration": 0.01,
    "slotframeLength": 28
},
'sfl_360ms_motes_14_top_reliable_slots_df_': {
    "slotDuration": 0.01,
    "slotframeLength": 36
}
}
...
if __name__ == "__main__":
    ...
    for c_name, c in configurations.items():
        ...
        # set config
        config['heuristic-sf'] = {}
        config['heuristic-sf']['topology'] = 'reliable'
        config['heuristic-sf']['slots'] = 'df'
