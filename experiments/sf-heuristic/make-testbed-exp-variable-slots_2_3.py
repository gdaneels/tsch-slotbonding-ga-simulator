...
configurations = {
'sfl_153ms_motes_14_top_heuristic_delta_001_f_23_': {
    "slotDuration": 0.09,
    "slotframeLength": 17,
    "delta": 0.01
},
'sfl_153ms_motes_14_top_heuristic_delta_005_f_23_': {
    "slotDuration": 0.09,
    "slotframeLength": 17,
    "delta": 0.05
},
'sfl_153ms_motes_14_top_heuristic_delta_030_f_23_': {
    "slotDuration": 0.09,
    "slotframeLength": 17,
    "delta": 0.3
},
'sfl_333ms_motes_14_top_heuristic_delta_001_f_23_': {
    "slotDuration": 0.09,
    "slotframeLength": 37,
    "delta": 0.01
},
'sfl_333ms_motes_14_top_heuristic_delta_005_f_23_': {
    "slotDuration": 0.09,
    "slotframeLength": 37,
    "delta": 0.05
},
'sfl_333ms_motes_14_top_heuristic_delta_030_f_23_': {
    "slotDuration": 0.09,
    "slotframeLength": 37,
    "delta": 0.3
}
...
if __name__ == "__main__":
    ...
    for c_name, c in configurations.items():
        cnt = 0
        # set config
        config["ga"]["generations"] = 10000
        config["sf-heuristic"]["delta"] = c['delta']
        config["sf-heuristic"]["testbed_results"]["reliabilities"]['TSCH_SLOTBONDING_1000_KBPS_PHY'] = "testbed-results/reliability-TSCH_SLOTBONDING_1000_KBPS_PHY_2_3.json"
