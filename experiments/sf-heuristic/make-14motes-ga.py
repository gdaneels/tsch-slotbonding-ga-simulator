...
configurations = {
'sfl_120ms_motes_14_top_ga_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 12
},
'sfl_200ms_motes_14_top_ga_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 20
},
'sfl_280ms_motes_14_top_ga_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 28
},
'sfl_360ms_motes_14_top_ga_delta_000_': {
    "slotDuration": 0.01,
    "slotframeLength": 36
}
}
...
if __name__ == "__main__":
    ...
    for c_name, c in configurations.items():
        ...
        config["sf-heuristic"]["delta"] = 0.05
